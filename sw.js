// v94-ui-r45: main→utility keyboard context handoff; pending document-scroll restore utility fokusundan önce iptal edilir.
...
const SURUM = "centik-v94-ideal-shared-drawer-r45";
const KABUK = [
  "./",
  "./index.html",
  "./manifest.json",
