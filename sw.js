// v94-ui-r18: Utility trackpad kapanışında tepeye ulaştıktan sonra ek pull guard + daha yüksek kapanış eşiği kullanılır.
...
const SURUM = "centik-v94-ideal-shared-drawer-r18";
const KABUK = [
  "./",
  "./index.html",
  "./manifest.json",
