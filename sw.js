// v94-ui-r36: tek KeyboardManager içinde virtual-provider typing-anchor stabilizer; input auto-pan sıçraması dengelenir.
...
const SURUM = "centik-v94-ideal-shared-drawer-r36";
const KABUK = [
  "./",
  "./index.html",
  "./manifest.json",
