// v94-ui-r13: Çakılı boş-yüzey aşağı çekme wrapper'a taşındı; Takvim üstüne ay başlığı ve çekme alanı eklendi.
...
const SURUM = "centik-v94-ideal-shared-drawer-r13";
const KABUK = [
  "./",
  "./index.html",
  "./manifest.json",
