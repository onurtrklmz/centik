// r56-diagnostic: r54 davranışı korunur; yalnız klavye/çekmece olay günlüğü eklenmiştir.
// r54: utility cal-head geometry remains fixed while keyboard is open.
...
const SURUM = "centik-v95-r56-diagnostic";
const KABUK = [
  "./",
  "./index.html",
  "./manifest.json",
